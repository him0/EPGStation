...
import LiveThumbnailModel from './api/stream/LiveThumbnailModel';
...
export const set = (container: Container): void => {
    ...
    container.bind<ILiveThumbnailModel>('ILiveThumbnailModel').to(LiveThumbnailModel).inSingletonScope();
