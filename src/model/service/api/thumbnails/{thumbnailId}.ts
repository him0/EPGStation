...
export const get: Operation = async (req, res) => {
    ...
    try {
        const filePath = await thumbnailApiModel.getIdFilePath(parseInt(req.params.thumbnailId as string, 10));
...
export const del: Operation = async (req, res) => {
    ...
    try {
        await thumbnailApiModel.delete(parseInt(req.params.thumbnailId as string, 10));
